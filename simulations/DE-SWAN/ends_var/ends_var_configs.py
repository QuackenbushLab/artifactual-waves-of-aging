...
FLIP = False # whether to flip the noise shape (e.g. v-shaped becomes ^-shaped)

MIN_NOISE_MULTIPLIER = 0.5 # multiplicative factor for noise at minimum variance point 
MAX_NOISE_MULTIPLIER = 4.0 # multiplicative factor for noise at maximum variance point 

RESULTS_DIR = "simulations/DE-SWAN/ends_var/results/results_06-10-26" # folder for result
