...
ENDS_VAR_DIST_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, ".."))

if ENDS_VAR_DIST_DIR not in sys.path:
    sys.path.insert(0, ENDS_VAR_DIST_DIR)

import ends_var_configs as config
