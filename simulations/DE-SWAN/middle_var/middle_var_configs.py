...
NOISE_TREND = "ends"  # specifies where variance is changing (see de_SWAN_helpers.py)
NOISE_SHAPE = "v" # shape of noise (see de_SWAN_helpers.py)
FLIP = True # whether to flip the noise shape (e.g. v-shaped becomes ^-shaped)

MIN_NOISE_MULTIPLIER = 0.25 # multiplicative factor for noise at minimum variance point 
MAX_NOISE_MULTIPLIER = 6.0 # multiplicative factor for noise at maximum variance point 

RESULTS_DIR = "simulations/DE-SWAN/middle_var/results/results_06-10-26" # folder for result
